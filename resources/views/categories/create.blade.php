        ...
        <div class="container-content">
            <form class="margin-t" action="{{route('category.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Enter your category" required="">
                </div>
                <div class="form-control">
                    <label>Image</label>
                ...
                <button class="btn btn-secondary btn-sm" onclick="window.history.go(-1); return false;">Cancle</button>
